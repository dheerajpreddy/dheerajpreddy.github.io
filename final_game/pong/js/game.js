...
var fontAssets = {
  scoreLeft_x: gameProperties.screenWidth * 0.50,
...
mainState.prototype = {
  ...
  initGraphics: function() {
    ...
    this.tf_scoreRight = game.add.text(fontAssets.scoreRight_x, fontAssets.scoreTop_y, "0", fontAssets.scoreFontStyle1);
